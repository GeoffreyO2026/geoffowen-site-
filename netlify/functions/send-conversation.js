...
async function sendViaResend(email, note, transcriptText) {
  const html = `
    <div style="font-family: Georgia, serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; line-height: 1.7;">
      ...
      <div style="white-space: pre-wrap; font-family: Arial, sans-serif; font-size: 14px; color: #333;">${transcriptText.replace(/\n/g, '<br>')}</div>
      <hr style="border: none; border-top: 1px solid #ddd; margin: 28px 0;">
      <p style="font-family: Arial, sans-serif; font-size: 13px; color: #555;">If you'd like to talk through this in more detail without any obligation, you're welcome to book a free 45-minute call: <a href="https://calendly.com/geoffreyowen/45mins" style="color:#B8972A;">https://calendly.com/geoffreyowen/45mins</a></p>
    </div>
  `;
