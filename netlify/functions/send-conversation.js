Output the file content to pasteconst CATEGORIES = [
"Guilt and overwhelm",
...
Pick exactly one category from this list that best fits what the parent was asking about: ${CATEGORIES.map(c => "${c}").join(', ')}
Write a short, warm note (3-4 sentences, in Geoff's measured, non-salesy voice) that will appear at the top of an email to this parent, above the full conversation transcript. Reference what they actually discussed, specifically, not generically. Do not mention or offer a call, Calendly, or a consultation, that is not part of this email.
...
const html =     <div style="font-family: Georgia, serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; line-height: 1.8;">       <p style="color:#B8972A; font-family: Arial, sans-serif; font-size: 11px; letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 24px;">The Biologically Aligned Parenting Agent</p>       <p style="font-family: Georgia, serif; font-size: 17px; color: #1a1a1a; margin-bottom: 24px;">${note.replace(/\n/g, '<br>')}</p>       <hr style="border: none; border-top: 1px solid #ddd; margin: 28px 0;">       <p style="font-family: Arial, sans-serif; font-size: 12px; color: #888; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 16px;">Your full conversation</p>       <div style="white-space: pre-wrap; font-family: Georgia, serif; font-size: 15px; line-height: 1.8; color: #333;">${transcriptText.replace(/\n/g, '<br>')}</div>       <hr style="border: none; border-top: 1px solid #ddd; margin: 28px 0;">       <p style="font-family: Arial, sans-serif; font-size: 15px; color: #1a1a1a; margin-bottom: 16px;">If you'd like to go deeper on this, my free guide is a good next step: <a href="https://geoffreyowen.com/guide/download" style="color:#B8972A;">https://geoffreyowen.com/guide/download</a></p>     </div>  ;
...
to: [email],
subject: 'Your conversation with the Biologically Aligned Parenting Agent',
html: html
})
});
if (!response.ok) {
